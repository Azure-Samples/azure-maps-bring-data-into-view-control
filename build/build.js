...
(async function build() {
    ...
    const outFilePath = `${distDirPath}/azure-maps-bring-data-into-view-control.js`;
    const outMinFilePath = `${distDirPath}/azure-maps-bring-data-into-view-control.min.js`;
